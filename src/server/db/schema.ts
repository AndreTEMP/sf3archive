...
export const matchs = createTable(
  "matches",
  {
    ...
    playerOneWinLoss: boolean("player_one_win_loss", { length: 256 }),
    ...
    playerTwoWinLoss: boolean("player_two_win_loss", { length: 256 }),
    playerOnePerfect: boolean("player_one_perfect", { length: 256 }),
